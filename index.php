...
$all_versions = array( 
	"2.17" => array( 
		"date" => "2023-Jul-13", 
		"msi" => "BletchMAME_2_17.msi",
		"zip" => "BletchMAME_2_17.zip",
		"notes" => "Maintenance release"
	), 
	"2.16" => array( 
		"date" => "2022-Aug-14", 
		"msi" => "BletchMAME_2_16.msi",
		"zip" => "BletchMAME_2_16.zip",
		"notes" => "History.xml and 7-Zip support"
	), 
	"2.15" => array( 
		"date" => "2022-May-22", 
		"msi" => "BletchMAME_2_15.msi",
		"zip" => "BletchMAME_2_15.zip",
		"notes" => "Miscellaneous UI enhancements"
	), 
	"2.14" => array( 
		"date" => "2022-Mar-26", 
		"msi" => "BletchMAME_2_14.msi",
		"zip" => "BletchMAME_2_14.zip",
		"notes" => "Cassette device UI and miscellaneous enhancements"
	), 
	"2.13" => array( 
		"date" => "2022-Feb-26", 
		"msi" => "BletchMAME_2_13.msi",
		"zip" => "BletchMAME_2_13.zip",
		"notes" => "Maintenance update"
	), 
	"2.12" => array( 
		"date" => "2022-Feb-17", 
		"msi" => "BletchMAME_2_12.msi",
		"zip" => "BletchMAME_2_12.zip",
		"notes" => "MAME.ini importing"
	), 
	"2.11" => array( 
		"date" => "2021-Dec-27", 
		"msi" => "BletchMAME_2_11.msi",
		"zip" => "BletchMAME_2_11.zip",
		"notes" => "Maintenance update"
	), 
	"2.10" => array( 
		"date" => "2021-Dec-5", 
		"msi" => "BletchMAME_2_10.msi",
		"zip" => "BletchMAME_2_10.zip",
		"notes" => "Improved auditing and miscellaneous enhancements"
	), 
	"2.9" => array( 
		"date" => "2021-Oct-23", 
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="images/screenshot20.png"><img src="images/screenshot20.png" class="mycell" /></a></td>
        </tr>
    </table>
